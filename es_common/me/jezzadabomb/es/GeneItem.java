...
public class GeneItem extends Item
{
	...
	public GeneItem(int ID, String ItemName)
	{
		super(ID);
		setMaxStackSize(1);
	...
	{
	         iconIndex = iconRegister.registerIcon("ElementalScience:Machines");
	}
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ++par5;
            Block var11;
                var11 = ElementalSciences.geneChamberDoor;
	...
	public String getTextureFile() {
        return ServerHandler.ITEMS_PNG;
	}
