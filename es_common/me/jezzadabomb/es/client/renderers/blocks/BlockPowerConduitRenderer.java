...
import me.jezzadabomb.es.common.lib.helpers.Helper;
import me.jezzadabomb.es.common.lib.util.BaseBlockRenderer;
import me.jezzadabomb.es.common.lib.util.IconRegistry;
import net.minecraft.block.Block;
import net.minecraft.client.renderer.RenderBlocks;
import net.minecraft.util.Icon;
import net.minecraft.world.IBlockAccess;

public class BlockPowerConduitRenderer extends BaseBlockRenderer {
    private static BlockPowerConduitRenderer INSTANCE = new BlockPowerConduitRenderer();

    public static BlockPowerConduitRenderer instance() {
        return INSTANCE;
    }
