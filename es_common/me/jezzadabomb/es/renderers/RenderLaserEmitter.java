...
public class RenderLaserEmitter extends BaseBlockRenderer {

    private static RenderLaserEmitter INSTANCE = new RenderLaserEmitter();

    public static RenderLaserEmitter instance() {
        return INSTANCE;
    }
