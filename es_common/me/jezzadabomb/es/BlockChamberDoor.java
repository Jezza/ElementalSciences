...
public class BlockChamberDoor extends Block
{	
	protected BlockChamberDoor(int BlockID, String BlockName)
    {
	...
	{
	         blockIcon = iconRegister.registerIcon("ElementalSciences:Machines");
	}
...
*/
    ...
    {
        return (par1 & 8) != 0 ? 0 : (ElementalSciences.geneChamberDoorItem.itemID);
    }
    ...
    {
        return ElementalSciences.geneChamberDoorItem.itemID;
    }
